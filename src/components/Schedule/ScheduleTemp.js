...
var dataBook = { time_id: null, token: null, destination: null };
                      ...
                      <Grid item xs={12} >
                        <Grid item xs container direction="row" justify="center" alignItems="center">
                          ...
                          <FormDialog
                            ...
                            handleContinue = {(time_id,token)=>this.handleContinue(this.props.key,this.props.authToken)}
